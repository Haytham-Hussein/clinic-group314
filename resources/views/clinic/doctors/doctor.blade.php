...
@section("doctor")
<div class="d-flex flex-column gap-3 details-card doctor-details mt-3 align-items-center">
  <div class="details d-flex gap-2 align-items-center">
      <img src="{{ asset("ClinicAssets")}}/assets/images/major.jpg" alt="doctor" class="img-fluid rounded-circle" height="150"
          width="150">
